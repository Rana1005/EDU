...
class users{
	...
	{
 	$query=$this->conn->query("select email,pass from test_reg where email='$email' and pass='$pass'");
	...
	{
		$query=$this->conn->query("select * from test_reg where email='$email'");
